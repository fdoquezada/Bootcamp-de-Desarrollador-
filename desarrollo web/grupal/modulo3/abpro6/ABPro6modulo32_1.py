print('='*25 +" Bienbenido a nuestro sistema de compras, por favor digite una opccion  " + '='*25)
...
def compra():
    ...
    compra_cliente=input('ingrese nombre de cliente: ')
...
def compra_aprobada():  #Funcionalidad que autoriza la compra. No es necesario que actualicen el stock de la bodega virtual(aprueba/cancela)
    if validacion_compra()==True:
        ...
        print('='*25 +" Gracias por su compra " + '='*25)
