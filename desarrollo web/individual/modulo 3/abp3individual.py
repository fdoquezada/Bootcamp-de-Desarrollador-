...
print(bienvenida)
print("-"*100)
origen = input("¿es ud originario de america latina? si /no: ")
...
afinidad = input("tiene afinidad con los deportes si/no: ")        
...
if  origen.upper() =="SI" and edad == 30 or edad < 59:
    ...
    print("te toca responder el cuertinorio de deportes en general")          
